-- Enhanced NCLEX Questions with Improved Rationales
-- Rationale improvements: Explains correct AND wrong answers, includes mnemonics, clinical pearls, and test-taking strategies
-- Run this INSTEAD of the original export to get better rationales
